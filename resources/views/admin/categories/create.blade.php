    ...
    <div>
        <form action="{{route('admin.categories.store')}}" method="post" id="addNew">
            ...
            <div class="form-group">
                ...
                <input id="title" class="form-control @if($errors->has('title')) alert-danger @endif" type="text" name="title" placeholder="title" value="{{old('title')}}"><br/>
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control @if($errors->has('description')) alert-danger @endif" id="description" cols="30" rows="10" value="{{ old('description') }}">{{ old('description') }}</textarea><br/>
